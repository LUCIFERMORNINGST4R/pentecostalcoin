...
uint256 hashGenesisBlock("0x0000000074660cd7adf7628a5c5aa932925091639e5b4bb7558d0765968e743f");
...
const string strMessageMagic = "Pentecostalcoin Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uPCC
...
static const int64 nTargetTimespan = 150;  // every block
static const int64 nTargetSpacing = 2.5 * 60; // 2.5 minits
...
void ThreadScriptCheck() {
    RenameThread("pentecostalcoin-scriptch");
...
bool CBlock::ConnectBlock(CValidationState &state, CBlockIndex* pindex, CCoinsViewCache &view, bool fJustCheck)
{
    ...
    // BIP16 didn't become active until 18-05-2018
    int64 nBIP16SwitchTime = 1526645499;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000d22b8b9b7edfa10f3131cb043930c0948abce8238afca3c712566d60");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        const char* pszTimestamp = "Ny times May 13/5/2018 Trump Vows to Save Jobs in China Lost After US Sanctions";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("041c412c1c519b891fe3c6e23a31c99c76a61a1d76740aa7e44cef513b53bf8ab07f230db005313eb6e7328b4da569eafa36c33013d54c8677cc75db7667937a56") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1526235119;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 3466554749;

        if (fTestNet)
        {
            block.nTime    = 1526235200;
            block.nNonce   = 2764747215;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xbb507332f499fa2fbb08a8b18d5aebe5e0914dfe1256209234f3f5d4ad7b5055"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf3, 0xba, 0xb8, 0xd5 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PentecostalcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PentecostalcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static PentecostalcoinMiner(CWallet *pwallet)
{
    printf("PentecostalcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("pentecostalcoin-miner");
    ...
    try { loop {
        ...
        printf("Running PentecostalcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("PentecostalcoinMiner terminated\n");
        throw;
    }
}

void GeneratePentecostalcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&PentecostalcoinMiner, pwallet));
}
