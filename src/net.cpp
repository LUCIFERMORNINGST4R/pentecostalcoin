...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("pentecostalcoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pentecostalcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pentecostalcoin.pentecostalcoin.com", "seed.pentecostalcoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"pentecostalcoin.pentecostalcoin.com", "testnet-seed.pentecostalcoin.pentecostalcoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pentecostalcoin is probably already running."), addrBind.ToString().c_str());
        else
...
{
    printf("StopNode()\n");
    GeneratePentecostalcoins(false, NULL);
    MapPort(false);
