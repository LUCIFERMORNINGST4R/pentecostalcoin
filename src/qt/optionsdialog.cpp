    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new PentecostalcoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->pentecostalcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Pentecostalcoin."), QMessageBox::Ok);
