...
#ifndef H_PENTECOSTALCOIN_SCRIPT
#define H_PENTECOSTALCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPentecostalcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Pentecostalcoin always counted CHECKMULTISIGs
