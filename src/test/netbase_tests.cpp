...
{
    BOOST_CHECK(TestSplitHost("www.pentecostalcoin.org", "www.pentecostalcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.pentecostalcoin.org]", "www.pentecostalcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.pentecostalcoin.org:80", "www.pentecostalcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.pentecostalcoin.org]:80", "www.pentecostalcoin.org", 80));
